...
public class homekeeperQnAAdapter extends BaseAdapter {
    Context context;
    ...
    public homekeeperQnAAdapter(Context context, ArrayList<HomeKeeperQnA> dtos, Point size) {
    ...
    public void addDto(HomeKeeperQnA dto){
        dtos.add(dto);
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = inflater.inflate(R.layout.qna_item,
                    parent, false);
        ...
        final HomeKeeperQnA dto = dtos.get(position);
